...
void CutlassGroupGemmNVFP4GroupwiseScaledSM100(TensorView int_workspace_buffer,
          ...
          return DISPATCH_TILE_N(tile_n, TILE_N, [&] {
            return DISPATCH_TILE_K(tile_k, TILE_K, [&] {
              if constexpr (is_valid_config<c_type_in_a, c_type_in_b, c_type_sf_a, c_type_sf_b,
                ...
                auto status = flashinfer::group_gemm::CutlassNVFP4GroupwiseScaledGroupGEMMSM100<
